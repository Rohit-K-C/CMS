    ...
    <body>
        ...
        <header>
            ...
            <div class="about us">
                <br><br><br>
                <div class="box">
                    <a href="image/Logo.jpg"><img src="image/Logo.jpg" class="logo" alt="logo"></a>
                    ...
                    as wind and solar power, to reduce its carbon emissions and improve its sustainability</p>
                </div>
                <div class="box">
                    <a href="image/success.jpg"><img src="image/success.jpg" class="success" alt="success"></a>
                ...
                <div class="box">
                    <a href="image/benchmark.jpg"><img src="image/benchmark.jpg" class="benchmark" alt="benchmark"></a>
                ...
                <div class="box">
                    <a href="image/defstan.jpg"><img src="image/defstan.jpg" class="defstan" alt="defstan"></a>
            ...
            <footer>
                <div class="container">
                    ...
                    <div class="last">
                        <div class="about">
                            <div class="escape"><h3>Company</h3><br></div>
                            <div class="quick">
                    ...
                    <div class="last">
                        <div class="about"><h3>Social Media</h3><br>
                            <div class="social">
                    ...
                    <div class="copyright"><p>Hongshi Cement @ 2022.</p></div>
                </div>
            </footer>
        </div>
    </body>
